...
async function postData(route,data, callback) { 
...
function loadModalData(idModal,route,form, callback) {
  var modal = $(idModal);
  $(idModal).modal('show');
      var loader = "<div align='center'><div class='sk-chase spinner-border-lg sk-primary'><div class='sk-chase-dot'></div><div class='sk-chase-dot'></div><div class='sk-chase-dot'></div> <div class='sk-chase-dot'></div><div class='sk-chase-dot'></div><div class='sk-chase-dot'></div></div></div>";
